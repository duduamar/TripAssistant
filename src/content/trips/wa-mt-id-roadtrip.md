---
trip_dates: Sat, Jul 25 – Sat, Aug 1, 2026
start_location: Bothell, WA
end_location: Bothell, WA
---

# WA–ID–MT Road Trip Planning
...
| Days | Dates | Location | Hotel (TBD) | Cost |
| --- | --- | --- | --- | --- |
...
## Day 1 (Sat, Jul 25, 2026) – Bothell → Leavenworth → Spokane

**Drive:** ~6.5–7 hrs

Highlight photo: [Leavenworth Adventure Park Alpine Coaster](https://www.leavenworthadventurepark.com/tumwatertwister-alpinecoaster)

![Leavenworth Adventure Park Alpine Coaster](https://static.wixstatic.com/media/3199ff_669cc015cc994c318f6a8c53ec8d02dc~mv2.png/v1/fill/w_812,h_561,al_c/3199ff_669cc015cc994c318f6a8c53ec8d02dc~mv2.png)
...
- Bothell → Leavenworth: ~2h25
- Leavenworth → Coulee City: ~1h40
- Coulee City → Steamboat Rock / Banks Lake: ~25 min
- Steamboat Rock / Banks Lake → Grand Coulee Dam: ~35 min
- Grand Coulee Dam → Spokane: ~1h50
...
Highlight photo: [Numerica SkyRide](https://my.spokanecity.org/riverfrontspokane/attractions/skyride/)

![Numerica SkyRide](https://static.spokanecity.org/photos/2019/03/26/skyride/16x7/large/skyride.jpg)

**Stops:**

- [Riverfront Park](https://my.spokanecity.org/riverfrontpark/) (Spokane)
  - Playground time
  - [Numerica SkyRide](https://my.spokanecity.org/riverfrontpark/attractions/skyride/)
  - [Spokane Falls](https://www.visitspokane.com/things-to-do/recreation/parks/spokanefalls/) (viewpoints are within Riverfront Park)
- [Coeur d’Alene City Park & Beach](https://www.cdaid.org/735/departments/parks/all-parks/coeur-dalene-city-park)
  - Lakefront beach and sand play

**Morning (Spokane):**

- Riverfront Park playground time (carousel or gondola if desired).
- [Numerica SkyRide](https://my.spokanecity.org/riverfrontpark/attractions/skyride/) (if open)
- Quick walk along the Spokane River and the falls viewpoint.

**Midday (drive to Coeur d’Alene):**

- Depart late morning; aim to arrive before lunch.
- Lunch in downtown Coeur d’Alene (walkable to the lakefront).

**Afternoon (CDA lakefront):**

- [City Park & Beach](https://www.cdaid.org/735/departments/parks/all-parks/coeur-dalene-city-park) for sand/water play.
- Fort Sherman playground
- [Tubbs Hill Nature Trails](https://www.tubbshill.org/) (short loop option) if kids have energy.
- Optional: [Coeur d’Alene Resort Boardwalk](https://www.cdaresort.com/boardwalk-bar/) for a scenic stroll.
...
- Keep a picnic/snack bag handy for the park and beach.
- Pack swim gear + towels in a day bag.

**Drive legs (approx, includes +20% buffer):**

- Spokane → Coeur d’Alene: ~45 min
...
Highlight photo: [Silverwood Theme Park](https://www.silverwoodthemepark.com/index.php)

![Silverwood roller coasters](https://www.silverwoodthemepark.com/images/contests/gallery/thumb/garden-1.jpg)
...
- Silverwood → Sandpoint: ~45 min

**Stay:** [Best Western Plus Ponderay Mountain Lodge](https://www.bestwestern.com/en_US/book/hotels-in-ponderay/best-western-plus-ponderay-mountain-lodge/propertyCode.13063.html) (Ponderay, Sandpoint area)
...
## Day 4 (Tue, Jul 28, 2026) – Sandpoint → Kootenai Falls → Kalispell

**Drive:** ~3.5–4.5 hrs

Highlight photo: [Kootenai Falls & Swinging Bridge](https://www.fs.usda.gov/r01/kootenai/recreation/kootenai-falls-and-swinging-bridge)

![Kootenai Falls Swinging Bridge](https://www.fs.usda.gov/sites/nfs/files/legacy-media/kootenai/Swinging%20Bridge%20Completed.jpg)

**Stops:**

- [Lake Pend Oreille](https://visitsandpoint.com/) viewpoints (pick a few, not all)
  - [Lakeview Park](https://www.sandpointidaho.gov/parks-and-recreation/page/lakeview-park) (Sandpoint, quick pull-in before ID-200)
  - [Sam Owen Campground day-use area](https://www.recreation.gov/camping/campgrounds/232202) (ID-200, lakeside views)
  - [Pend Oreille Scenic Byway pullouts](https://www.recreation.gov/gateways/13804) (signed scenic stops along ID-200)
- [Kootenai Falls & Swinging Bridge](https://www.fs.usda.gov/r01/kootenai/recreation/kootenai-falls-and-swinging-bridge)
  - Swinging bridge viewpoint
  - Short trail to falls

**Drive legs (approx, includes +20% buffer):**

- Sandpoint → Kootenai Falls: ~2h
- Kootenai Falls → Kalispell: ~2h20
...
**Plan:** Full day, short hikes + big views (pick 2–3)

Highlight photo: [Going‑to‑the‑Sun Road](https://www.nps.gov/glac/planyourvisit/goingtothesunroad.htm)

![Going-to-the-Sun Road view](https://www.nps.gov/common/uploads/grid_builder/glac/crop16_9/3D46CA45-B6DC-4792-73610CD68BB6FC28.jpg?width=640&quality=90&mode=crop)

**Morning (west side / Lake McDonald area):**

- [Trail of the Cedars](https://www.nps.gov/glac/planyourvisit/hikinglakemcdonald.htm) (short, accessible nature trail).

**Midday (Going‑to‑the‑Sun Road scenic drive):**

- [Going‑to‑the‑Sun Road](https://www.nps.gov/thingstodo/drive-gtsr.htm) with scenic pullouts.
- [Hidden Lake Overlook](https://www.nps.gov/glac/planyourvisit/hikingstmary.htm) from Logan Pass Visitor Center (shorter alpine hike with views).
  - 1.5 mile hike, we can skip if day is too long
...
- Kalispell → West Glacier area: ~55 min
- In-park drives between major stops: ~40–110 min (vary by traffic and parking)
- Return to Kalispell via the **outside loop** (St. Mary → US‑89/US‑2 → Kalispell): ~3h with buffer
...
**Drive:** ~5h40 (driving only, excludes stops)

Highlight photo: [Lookout Pass Scenic Lift Rides](https://skilookout.com/summer-scenic-lift-rides-and-mtn-bike-trails/)

![Scenic chairlift at Lookout Pass](https://skilookout.com/wp-content/uploads/2025/08/LP_Lift_ScenicRides16x9_6880-1400x788.jpg)
...
- Kalispell → St. Regis: ~3h05
- St. Regis → Wallace: ~55 min
...
- Towels
- Swim gear (swimsuits, goggles, water shoes)
